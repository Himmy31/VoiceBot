...
class JishakuBase(commands.Cog):  # pylint: disable=too-many-public-methods
    ...
    async def cog_check(self, ctx: commands.Context):
        ...
        if not ctx.author.id in self.bot.config['owner_ids']:
    ...
    @commands.command(name="load", aliases=["reload"], hidden=True)
    ...
    @commands.command(name="shutdown", aliases=["logout"], hidden=True)
    ...
    @commands.command(name="debug", aliases=["dbg"], hidden=True)
    ...
    @commands.command(name="curl", hidden=True)
    ...
    @commands.command(name="source", aliases=["src"], hidden=True)
    ...
    @commands.command(name="retain", hidden=True)
    ...
    @commands.command(name="py", aliases=["python"], hidden=True)
    ...
    @commands.command(name="py_inspect", aliases=["pyi", "python_inspect", "pythoninspect"], hidden=True)
    ...
    @commands.command(name="shell", aliases=["sh"], hidden=True)
    ...
    @commands.group(name="voice", aliases=["vc"], hidden=True)
